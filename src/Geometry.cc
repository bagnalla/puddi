...
namespace puddi
{
    namespace Geometry
    {
        ...
        std::vector<vec4> CreateCatmullRomCurve(const vec4& p0, const vec4& p1, const vec4& p2, const vec4& p3, float curviness)
        {
        ...
        std::vector<vec4> CreateBlob(float curviness, const vec4 verts[], int numOfVerts)
        {
        ...
        std::vector<vec4> CreateCircle(int numberOfVertices)
        {
            std::vector<vec4> vertices;
        ...
        std::vector<vec4> CreateCircle(int numberOfVertices, std::vector<vec4>& tangents)
        {
            tangents.clear();
        ...
        std::vector<vec4> CreateSphere(float definition)
        {
            double deltaTheta = M_PI / definition;
            double theta = 0;
            std::vector<vec4> sphere;

            std::vector<vec4> originalRing = CreateCircle(static_cast<int>(definition * 2));
        ...
        std::vector<vec4> CreateSphere(float definition, std::vector<vec4>& tangents, std::vector<vec4>& binormals)
        {
            tangents.clear();
            binormals.clear();
            ...
            std::vector<vec4> originalRing = CreateCircle(static_cast<int>(definition * 2), originalTangents);
            std::vector<vec4> ring1 = originalRing;
            std::vector<vec4> ring2;
        ...
        std::vector<vec4> CreateSphere2(int n)
        {
        ...
        std::vector<vec4> CreateCube(float size)
        {
        ...
        std::vector<vec4> CreateCubeNormals()
        {
            vec4 verts[] = {
        ...
        std::vector<vec4> CreateCubeTangents()
        {
            vec4 verts[] = {
        ...
        std::vector<vec4> CreateCubeBiNormals()
        {
            vec4 verts[] = {
        ...
        std::vector<vec2> CreateCubeTextureCoordinates()
        {
        ...
        std::vector<vec2> CreateSkyboxTextureCoordinates()
        {
            std::vector<vec2> texCoords;
        ...
        std::vector<vec4> CreatePrism(const std::vector<vec4>& originalShape, std::vector<vec4>& normals)
        {
            normals.clear();
        ...
        std::vector<vec4> CreateCylinderNormals(const std::vector<vec4>& circle)
        {
        ...
        std::vector<vec4> CreateSphereNormals(std::vector<vec4> sphere)
        {
            std::vector<vec4> normals;
