...
//	}
//
//	Rectangle* Text::CreateRectangleFromCharacter(char c)
//	{
//		int error;
//
//		/* retrieve glyph index from character code */
...
//		GLuint tex = Texture::CreateTextureFromBitmap(expanded_data, width, height, GL_LUMINANCE_ALPHA);
//
//		Rectangle *rect = new Rectangle(Puddi::GetRootObject());
//		rect->SetTexture(tex);
//
//		rect->Translate(vec4(-bitStreamFace->glyph->bitmap_left / (float)width, 0.0f, 0.0f, 0.0f));
//
//		return rect;
//	}
//}
